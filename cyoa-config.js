...
(function() {
    window.CYOA_CONFIG = {
        ...
        // 叙述者风格（与 HEAVENLY_PATHS 重叠的已移除：克系由 ruleTags C-克系 提供）
        NARRATOR_STYLES: [
        ...
        DEFAULT_GAME: {
            id: '',
            name: (window.CYOA_I18N_ZH && window.CYOA_I18N_ZH['ui.status.unnamedGame']) || '未命名游戏',
            author: '',
            version: '1.0.0',
            synopsis: '',
            worldSetting: {
            ...
            locations: [],         // ② 地点列表
            locationEdges: [],     // ② 地点间路径
            worldMap: null,        // 大地图：{ name, regions: [{ id, name, locationIds:[] }] }
